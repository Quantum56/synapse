...
pub const VGA_BUFFER_START_PHYS_ADDR: usize = 0xb8000;
...
lazy_static! {
    pub static ref WRITER: spin::Mutex<Writer> = spin::Mutex::new(Writer {
        ...
        buffer: unsafe { &mut *(VGA_BUFFER_START_PHYS_ADDR as *mut Buffer) },
    });
}
...
macro_rules! vga_print {
    ($($arg:tt)*) => ($crate::vga_graphics::_vga_print(format_args!($($arg)*)));
}
